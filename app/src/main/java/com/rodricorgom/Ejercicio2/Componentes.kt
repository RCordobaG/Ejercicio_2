...
import com.rodricorgom.Ejercicio2.databinding.ActivityComponentesBinding
...
private lateinit var binding: ActivityComponentesBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
     ...
     setContentView(binding.root)
        ...
        val navController = findNavController(R.id.nav_host_fragment_content_componentes)
